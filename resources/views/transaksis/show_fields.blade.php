...
<div class="form-group">
    ...
    <div class="form-group">
        ...
        <a href="{!! route('addNonSewaLapangan',['id'=>$id]) !!}" class="btn btn-primary">+ Makanan/Minuman</a>
    </div>
    <h4>Sewa Lapangan</h4>
    <table class="table">
        <thead>
        ...
        @endphp
            @forelse($transaksi->sewa($id) as $item)
                <tr>
                    ...
                    @endphp
                    <td><a class="btn btn-xs btn-danger" href="{!! route('hapusSewa',['id' => $item->id]) !!}">Hapus</a></td>
                </tr>
            @empty
                <tr>
